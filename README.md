...
```
cd existing_repo
git remote add origin https://gitlab.com/tuananh2604/fizo-it-team.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/tuananh2604/fizo-it-team/-/settings/integrations)
